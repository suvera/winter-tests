...
USER=root
SERVICE_NAME=MyApp
SERVICE="$BASEDIR/service.php"
CONFIG_DIR=""
ADMIN_PORT="9091"
ADMIN_TOKEN_FILE=""
LOG_FILE="${BASEDIR}/../logs/${SERVICE_NAME}.log"
PID_FILE="${BASEDIR}/../logs/${SERVICE_NAME}.pid"
...
Options:
    ...
    restart  - Stop, then Start $SERVICE_NAME
    status   - Check if $SERVICE_NAME is running
    test     - Check if $SERVICE_NAME is healthy
EOF
    exit 2
}
